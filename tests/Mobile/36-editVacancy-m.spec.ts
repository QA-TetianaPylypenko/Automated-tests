...
test.describe.serial('Display, edit vacancy - mobile set', () => {
	test('Edit vacancy', async ({ page }) => {
		...
		await createNewVacancy.openVacancyPageMobile()
	...
	test('Checking page with list of members (empty)', async ({ page }) => {
